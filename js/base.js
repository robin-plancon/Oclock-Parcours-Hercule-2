...
const base = {
    ...
    printFriends: function (friends) {
        ...
        if (!friends || !Array.isArray(friends)) {
            listElem.innerHTML =
                '<li class="red">Tu as bien appelé <code>printFriends</code> mais tu ne sembles pas avoir passé de tableau en argument</li>';
        } else {
    ...
    fillProfil: function (profil) {
        ...
        if (!profil || typeof profil !== "object") {
            listElem.innerHTML =
                '<li class="red">Tu as bien appelé <code>fillProfil</code> mais tu ne sembles pas avoir passé d\'objet en argument</li>';
        } else {
            if (
                ...
                listElem.innerHTML =
                    "<li class=\"yellow\">Pour un meilleur affichage essaye de respecter les noms de propriétés donnés dans l'énoncé et n'oublie aucune propriété</li>";
            } else if (
                typeof profil.name !== "string" ||
                typeof profil.inRelationship !== "boolean" ||
                typeof profil.job !== "string" ||
                typeof profil.age !== "number" ||
                (typeof profil.department !== "number" &&
                    typeof profil.department !== "string") ||
                typeof profil.arm !== "number"
            ) {
                listElem.innerHTML =
                    '<li class="yellow">Ça fonctionne mais certains types de valeurs ne sont pas idéalement choisis</li>';
            }
